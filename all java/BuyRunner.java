public class BuyRunner {
    public static void main(String [] args){
        ...
        Buy.bookMovieTicket("kalki2892AD","Harikrishna",3,200);
        Buy.bookMovieTicket("kalki2892AD","HARIKRIISHAN",4,200);
        Buy.bookMovieTicket("kalki2892AD","PRABHAS",5,600);
        Buy.bookMovieTicket("kalki2892AD"," DARLING",6,300);
        Buy.buyEgg(8, 6);
        Buy.buyEgg(3, 6);
