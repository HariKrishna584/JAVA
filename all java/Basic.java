 class Country
{
	...
	public static void pins(int[] pincodes)
	{
		...
		for(int numbers=0;numbers<pincodes.length;numbers++)
		{
		...
		public static void prime(String[] priministers)
	{
		...
		for(int count=0;count<priministers.length;count++)
		{
	...
	public static void cabinetMinisters(String[] cabinetMinisters)
	{
        ...
        for(int num=0;num<cabinetMinisters.length;num++)
		{
	...
	public static void parties(String[] politicalParties)
	{
        ...
        for(int num=0;num<politicalParties.length;num++)
		{
